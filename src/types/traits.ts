...
export const TRAITS: Trait[] = [
  ...
  // Label is 'Presence', not 'Masculinity' — the trait scores posture and
  // bearing, and rating how masculine a real person is reads as objectifying
  // them (App Store guideline 1.2). The id stays 'masculinity' so stored
  // scans and the scoring API contract keep working.
  { id: 'masculinity', label: 'Presence', plan: 'Posture workout', teaseNoun: 'presence' },
